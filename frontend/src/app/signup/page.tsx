...
export default function SignupPage() {
  return (
    <main className="min-h-screen flex flex-col md:flex-row-reverse relative overflow-hidden auth-gradient-mesh noise-overlay transition-colors">
      {/* Right branding panel - hidden on mobile, visible on md+ */}
      <div className="hidden md:flex md:w-[45%] lg:w-1/2 relative items-center justify-center bg-gradient-to-bl from-emerald-500 via-teal-600 to-indigo-600 dark:from-emerald-900 dark:via-teal-900 dark:to-indigo-900 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-[15%] right-[10%] w-18 md:w-22 lg:w-28 h-18 md:h-22 lg:h-28 border-2 border-white/20 rounded-full animate-float" />
